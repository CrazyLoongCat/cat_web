const i18n = {
  'zh-CN': {
    ...
    'searchTable.columns.mainOrderId': '订单ID',
    'searchTable.columns.time': '下单时间',
    'searchTable.columns.statusName': '完成状态',
    'searchTable.columns.paidAmount': '实付金额',
    'searchTable.columns.receiveName': '收件人姓名',
    'searchTable.columns.receiveAddress': '地址',
    'searchTable.columns.receivePhone': '手机号',
    'searchTable.columns.goodsName': '商品名称及数量',
