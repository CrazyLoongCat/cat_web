const i18n = {
  ...
  'zh-CN': {
    ...
    'workplace.popularContents': '我的订单',
    'workplace.unSubmit': '未提交',
    'workplace.submit': '已提交',
    'workplace.finished': '已完成',
    'workplace.column.code': '订单编号',
    'workplace.column.creatdate': '下单时间',
    'workplace.column.abname': '商品名称',
    'workplace.column.abiid': '商品ID',
    'workplace.column.num': '商品数量',
    'workplace.column.price': '商品价格',
    'workplace.column.contacts': '收件人姓名',
    'workplace.column.tel': '收件人电话',
    'workplace.column.address': '地址',
    'workplace.column.statedesc': '完成状态',
    'workplace.column.prices': '实付金额',
    'workplace.column.oprices': '应付金额',
